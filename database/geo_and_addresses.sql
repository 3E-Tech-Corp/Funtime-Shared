...
-- =============================================
-- Sample usage for affiliate sites:
-- =============================================
/*

-- Find addresses within 10km of a location
...
SELECT a.Id, a.Line1, a.Line2, a.PostalCode,
       ...
       c.Name AS City,
       p.Name AS ProvinceState, p.Code AS ProvinceCode,
       co.Name AS Country, co.Code2 AS CountryCode
FROM Addresses a
JOIN Cities c ON a.CityId = c.Id
