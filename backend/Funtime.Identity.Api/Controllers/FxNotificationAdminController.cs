...
[Authorize(Roles = "SU")]
public class FxNotificationAdminController : ControllerBase
{
    private readonly IConfiguration _configuration;
    private readonly ILogger<FxNotificationAdminController> _logger;
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly string _connectionString;

    public FxNotificationAdminController(IConfiguration configuration, ILogger<FxNotificationAdminController> logger, IHttpClientFactory httpClientFactory)
    {
